...
case class ValidValidatedCheckedMatcher[T](check: ValueCheck[T]) extends OptionLikeCheckedMatcher[Validated[?, T], T]("Valid", _.toEither.toOption, check)

case class InvalidValidatedMatcher[T]() extends OptionLikeMatcher[Validated[T, ?], T]("Invalid", _.toEither.left.toOption)
case class InvalidValidatedCheckedMatcher[T](check: ValueCheck[T]) extends OptionLikeCheckedMatcher[Validated[T, ?], T]("Invalid", _.toEither.left.toOption, check)
